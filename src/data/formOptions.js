export const GENDER_OPTIONS = ["Maschio", "Femmina", "Transessuale", "Altro"];

export const FAMILY_ROLES_OPTIONS = ["Donna sola con minori", "Uomo solo con minori", "Coppia senza figli", "Coppia con figli", "Altro"];
...
export const EDUCATION_LEVEL_OPTIONS = ["Nessuno", "Elementare", "Licenza media", "Diploma scuola superiore", "Università", "Non dichiarato", "Altro"];

export const EDUCATION_LEVEL_IT_OPTIONS = ["Nessun titolo", "Licenza media in Italia", "Diploma di scuola superiore in Italia", "Università in Italia", "Non dichiarato", "Altro"];
...
export const REFERRAL_OPTIONS = ["Comune di Verona", "Volontari fuori questura", "CESAIM", "Ente partner", "Social Media/Sito web", "Passaparola", "Altro"];
